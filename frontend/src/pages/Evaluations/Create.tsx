    ...
    <div className="max-w-4xl mx-auto h-full flex flex-col space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden flex-1">
        <form onSubmit={handleSubmit} className="p-6 space-y-8 flex flex-col h-full overflow-y-auto">
          ...
          <div className="pt-6 mt-auto border-t border-gray-200 flex justify-end gap-3">
            <button
              type="button"
              onClick={() => navigate("/evaluations")}
            ...
            <button
              type="submit"
              disabled={loading}
              className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <>
