...
export default function ApproveNode({ data, selected }: any) {
  return (
    <div className={`bg-white rounded-lg shadow-md border-2 ${selected ? 'border-orange-500' : 'border-gray-200'} min-w-[200px]`}>
      ...
      <div className="bg-orange-50 rounded-t-lg p-2 flex items-center gap-2 border-b border-gray-100">
        ...
        <span className="font-medium text-sm text-gray-700">审批节点</span>
      </div>
      <div className="p-3 flex flex-col gap-2">
        <div className="text-sm font-semibold text-gray-800">{data.label || '等待审批'}</div>
        {data.approver && (
